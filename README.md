...
- \[system\] **"dref"**
    ...
    - *Long Description:* [`DEFUN`][f472] defines a first-class object: a
    ...
    - *Source control:* [GIT](https://github.com/melisgl/dref.git)
...
- \[reader\] **DREF-ORIGIN** *[DREF][d930]*
    ...
    [`*STANDARD-OUTPUT*`][e7ee] when it's `PAX:DOCUMENT`ed:
...
[Basic Operations][662d] (e.g. `PAX:DOCUMENT-OBJECT*`). For
...
[1281]: #x-28DREF-3ADEFSTRUCT-2A-20MGL-PAX-3AMACRO-29 "DREF:DEFSTRUCT* MGL-PAX:MACRO"
...
[cc04]: #x-28DREF-3ADREF-LOCATIVE-20-28MGL-PAX-3AREADER-20DREF-3ADREF-29-29 "DREF:DREF-LOCATIVE (MGL-PAX:READER DREF:DREF)"

[cc04f]: #x-28MGL-PAX-3AREADER-20MGL-PAX-3ALOCATIVE-29 "MGL-PAX:READER MGL-PAX:LOCATIVE"
